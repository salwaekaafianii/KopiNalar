  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        // LIST NOTIFIKASI dengan Pull-to-Refresh
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (notif['createdAt'] != null) {
                createdAt = DateTime.tryParse(notif['createdAt']);
              }

              // Ambil ikon berdasarkan tipe
              final iconData = controller.getIconForType(
                notif['type'] ?? 'info',
              );
              ...
              return Dismissible(
                ...
                key: Key(notif['_id'] ?? 'notif_$index'),
