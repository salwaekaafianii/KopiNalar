            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Masuk ke akunmu untuk melihat riwayat pesanan',
                    style: GoogleFonts.poppins(
                      fontSize: 13,
        ...
        return RefreshIndicator(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final status = controller.getStatusLabel(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        controller.formatDate(order['createdAt']?.toString()),
                        style: GoogleFonts.poppins(
                          fontSize: 11,
                      ...
                      Row(
                        children: [
                          ClipRRect(
                            ...
                            child:
                                firstItem != null &&
                                    firstItem['image']?.toString().isNotEmpty ==
                                        true
                                ? Image.network(
                                    firstItem['image'],
                                    width: 50,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            controller.getFormatRupiah(order['totalPayment']),
                            style: GoogleFonts.poppins(
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                              color: const Color(0xFFFFB74D),
